      ...
      <div className="flex flex-col lg:flex-row mx-auto lg:mx-0 max-w-[355px] lg:max-w-full  lg:gap-14 rounded-xl w-full bg-[#edf2f4] dark:bg-[#001d3d] shadow-lg">
        {data && (
          <>
            <img
              src={data.imgsUrl}
              className="w-full lg:w-[400px] bg-white cursor-pointer rounded-t-xl lg:rounded-l-xl lg:rounded-t-none h-[240px] lg:h-[400px] object-cover"
              alt="Recipe img"
            />
            <div className="flex flex-col relative w-full p-4 lg:p-8">
              <div className="flex justify-between items-center mb-1 lg:mb-2 ">
                <h3 className="font-bold text-lg lg:text-xl">{data.title}</h3>
              ...
              <h2 className="mb-1 lg:mb-2">{data.ingredeints}</h2>
              <p className="mb-4 lg:mb-2">{data.method}</p>
